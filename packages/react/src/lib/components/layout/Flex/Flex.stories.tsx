...
const Box = ({
  ...
  <div
    className={`p-4 bg-secondary text-secondary-foreground font-medium rounded border shadow-sm flex items-center justify-center ${className}`}
  >
    {children}
  </div>
);
...
export const FlexItemProps: Story = {
  render: () => (
    <Flex gap="md" className="w-[600px] border p-4 rounded-md h-[150px]">
      <FlexItem
        flex="1"
        className="bg-primary/10 border-dashed border p-4 flex items-center justify-center rounded"
      >
        Flex 1 (Grows)
      </FlexItem>
      <FlexItem
        flex="none"
        className="bg-secondary/10 border-dashed border p-4 flex items-center justify-center rounded w-[100px]"
      >
        Flex None (Fixed)
      </FlexItem>
      <FlexItem
...
export const AlignSelf: Story = {
  render: () => (
    <Flex
      gap="md"
      className="w-[600px] border p-4 rounded-md h-[150px]"
      align="center"
    >
      <Box>Center</Box>

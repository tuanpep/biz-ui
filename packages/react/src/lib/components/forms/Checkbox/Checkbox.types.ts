 ...
 */
export type CheckboxVariant = VariantProps<
  typeof import("./Checkbox.variants").checkboxVariants
>["variant"];

/**
 * Checkbox size types.
 */
export type CheckboxSize = VariantProps<
  typeof import("./Checkbox.variants").checkboxVariants
>["size"];
...
export interface CheckboxProps extends Omit<
  React.ComponentPropsWithoutRef<
    typeof import("@radix-ui/react-checkbox").Root
  >,
  "checked"
> {

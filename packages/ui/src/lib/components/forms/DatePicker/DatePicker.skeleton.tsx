...
import { datePickerSkeletonVariants, datePickerSkeletonLabelVariants } from './DatePicker.variants';
...
const DatePickerSkeleton = React.forwardRef<HTMLDivElement, DatePickerSkeletonProps>(

...
export const SingleFile: Story = {
    render: (args) => {
        const [files, setFiles] = useState<FileUploaderFile[]>([]);
        return <FileUploader {...args} files={files} onChange={setFiles} multiple={false} />;
    },
    args: {
...
export const WithError: Story = {
    render: (args) => {
        ...
        return <FileUploader {...args} files={files} onChange={setFiles} error="Some files failed to upload." />;
    },
};

...
import { Mail, Search, Bell, Settings, Trash, Plus, Check, AlertCircle } from 'lucide-react';
...
const meta: Meta<typeof IconButton> = {
    ...
    argTypes: {
        variant: {
            control: 'select',
            options: ['default', 'primary', 'secondary', 'tertiary', 'destructive', 'outline', 'ghost', 'success', 'warning'],

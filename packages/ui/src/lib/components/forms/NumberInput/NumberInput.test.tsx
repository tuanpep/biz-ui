...
import { NumberInput, NumberInputSkeleton } from "./index";
...
describe("NumberInput", () => {
  ...
  it("renders different sizes", () => {
    const { rerender } = render(
      <NumberInput {...defaultProps} size="sm" data-testid="sm-input" />,
    );
    expect(screen.getByTestId("sm-input")).toBeInTheDocument();

    rerender(
      <NumberInput {...defaultProps} size="lg" data-testid="lg-input" />,
    );
...
describe("NumberInputSkeleton", () => {
  ...
  it("renders skeleton with description", () => {
    render(
      <NumberInputSkeleton hasDescription data-testid="skeleton-with-desc" />,
    );

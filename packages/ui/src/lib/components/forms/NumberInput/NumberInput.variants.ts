...
export const numberInputInputVariants = cva(
  'flex w-full rounded-md border bg-background text-text-01 ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-text-03 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-colors',
  {
    variants: {
      variant: {
        default: 'border-border',
        inline: 'border-0 border-b border-border rounded-none bg-transparent px-0 hover:border-interactive-01 focus-visible:ring-0 focus-visible:border-interactive-01',
        'inline-filled': 'border-0 border-b border-border rounded-none bg-ui-01 px-0 hover:border-interactive-01 focus-visible:ring-0 focus-visible:border-interactive-01',
      },
      size: {

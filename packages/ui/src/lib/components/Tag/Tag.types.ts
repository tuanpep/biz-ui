 ...
 * Tag variant types.
 */
export type TagVariant = VariantProps<typeof import('./Tag.variants').tagVariants>['variant'];

/**
 * Tag size types.
 */
export type TagSize = VariantProps<typeof import('./Tag.variants').tagVariants>['size'];

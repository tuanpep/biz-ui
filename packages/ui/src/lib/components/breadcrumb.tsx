...
export interface BreadcrumbProps extends React.HTMLAttributes<HTMLElement> {
  ...
  linkComponent?: React.ComponentType<{ to?: string; href?: string; className?: string; children: React.ReactNode }>;
  /** Custom separator component */
  separator?: React.ReactNode;
}

const DefaultLink: React.ComponentType<{ to?: string; href?: string; className?: string; children: React.ReactNode }> =

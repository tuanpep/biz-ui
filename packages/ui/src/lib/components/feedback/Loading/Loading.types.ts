 ...
 * Spinner size types.
 */
export type SpinnerSize = VariantProps<typeof import('./Loading.variants').spinnerVariants>['size'];

/**
 * Loading overlay variant types.
 */
export type LoadingOverlayVariant = VariantProps<typeof import('./Loading.variants').loadingOverlayVariants>['variant'];

...
export const Default: Story = {
    render: (args) => {
        ...
        return <ProgressIndicator {...args} currentStep={step} onChange={setStep} />;
    },
};
    ...
    render: (args) => {
        ...
        return (
            <div className="h-[400px]">
                <ProgressIndicator {...args} orientation="vertical" currentStep={step} onChange={setStep} />
            </div>
        );
    },
    args: {
...
export const NoLabels: Story = {
    render: (args) => {
        const [step, setStep] = useState(args.currentStep || 1);
        return <ProgressIndicator {...args} currentStep={step} onChange={setStep} showLabels={false} />;
    },
};
    ...
    render: () => {
        ...
        return (
            <div className="flex flex-col gap-8 w-[600px]">
                <ProgressIndicator totalSteps={total} currentStep={step} onChange={setStep} showLabels />
